...
function examen_setup() {
	/*
		...
		* If you're building a theme based on examen, use a find and replace
		* to change 'examen' to the name of your theme in all the template files.
		*/
...
function examen_scripts() {
	...
	wp_style_add_data( 'examen-style', 'rtl', 'replace' );

	wp_enqueue_script( 'examen-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
